...
public class RegistryHandler {
    ...
    public static final RegistrySupplier<Item> MERMAID_BRA_MODIFIER = registerModifierItem("bra", new NecklaceModifier("mermaid_bra", 16777215), true);
    ...
    public static final RegistrySupplier<Item> TAIL_GRADIENT_MODIFIER = registerModifierItem("gradient", new NecklaceModifier("tail_gradient", 16777215), true);
    ...
    private static RegistrySupplier<Item> registerModifierItem(String type, NecklaceModifier modifier) {
        return registerModifierItem(type, modifier, false);
    }
    private static RegistrySupplier<Item> registerModifierItem(String type, NecklaceModifier modifier, boolean dyeable) {
        return registerItem(modifier.id() + "_modifier", key -> new NecklaceModifierItem(new Item.Properties().setId(key).arch$tab(CreativeModeTabs.INGREDIENTS), type, modifier, dyeable));
    }
