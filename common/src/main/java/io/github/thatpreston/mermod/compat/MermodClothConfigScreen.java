...
public class MermodClothConfigScreen {
    public static Screen build(Screen parent) {
        ...
        category.addEntry(entryBuilder.startBooleanToggle(Component.translatable("option.mermod.nightVisionFlashingFix"), MermodConfig.shouldDisableNightVisionFlashing())
